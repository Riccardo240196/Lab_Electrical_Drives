...
v = @(t) interp1([0 0.15 0.25 0.4 0.6 0.75 0.85 1 1.2],[0 0.6 0.6 0 0 -0.6 -0.6 0 0],t);
...
title('Trapezoidal speed profile','interpreter', 'latex');
...
Jmot = 0.192*(Jtrans+Jmass);    % Assumption
Jm = 1e-4;                      % Motor M.O.I
Jmot = Jm;
